...
@CrossOrigin(value = {"http://localhost:5173", "http://p2frontendbucketcj.s3-website-us-east-1.amazonaws.com"}, allowCredentials = "true") //Allows requests from any origin (including our frontend)
